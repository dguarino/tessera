...

{
    ...
    'Populations' : {
        ...
        'cell' : {
            ...
            'cellparams': {
                ...
                # # Whitout ACh
                # 'tau_m'      : 18.,  # ms, time constant of leak conductance (cm/gl)
                # 'v_rest'     : -65.0, # mV, resting potential (McCormick Prince 1986)
                # 'v_reset'    : -50.0, # mV, reset after spike
                # 'a'          : 28.,    # nS, subthreshold adaptation
                # 'b'          : .2,     # nA, spike-dependent adaptation
    ...
    'Injections' : {
        'cell' : {
            ...
            'amplitude' : [.8, .0], # default
            # 'start' : [200., 850.], # long duration
            'start' : [200., 350.], # short duration
            'stop' : 0.0
        },
    },
